...
AtCoder を続けていると、こんな悩みが生まれてきませんか？

> 「D問題以降は今は関係ない」「どれが次にやるべき問題か分からない」「ACしたのに画面が更新されていない」

**Next AC** はそんな悩みに特化して作った、**ABCのA〜C問題に絞った軽量ダッシュボード**です。
[AtCoder Problems](https://kenkoooo.com/atcoder/) のような多機能ツールとは異なる、**「初心者がいま必要なものだけ」** を届けることを目指しています。
